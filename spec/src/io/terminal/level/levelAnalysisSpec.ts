import { Count, Decimal, Integer, NEWLINE, Rank } from "@sagittal/general"
...
describe("formatJiNotationLevelAnalysis", (): void => {
    it("gives an explanation per JI notation level of what JI notation bound classes have what ranks there — both purely within the level, and though all levels up to that point", (): void => {
        ...
        jiNotationLevelsBestHistoryRanks[jiNotationLevel] = {
            ...
            [RANKS[BoundType.SIZE_CATEGORY_BOUND]]: 13 as Count<Decimal<Integer> & Rank<BoundType>>,
        }
        jiNotationLevelsBestCumulativeHistoryRanks[jiNotationLevel] = {
            [RANKS[BoundType.INA_MIDPOINT]]: 18 as Count<Decimal<Integer> & Rank<BoundType>>,
            [RANKS[BoundType.COMMA_MEAN]]: 17 as Count<Decimal<Integer> & Rank<BoundType>>,
            [RANKS[BoundType.SIZE_CATEGORY_BOUND]]: 15 as Count<Decimal<Integer> & Rank<BoundType>>,
        }
