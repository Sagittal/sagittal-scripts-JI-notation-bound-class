...
import { HALF_APOTOME, JI_NOTATION_LEVELS, JiNotationLevelId } from "@sagittal/system"
...
const visualizeJiNotationLevels = (): Io[] => {
    ...
    JI_NOTATION_LEVELS.forEach((jiNotationLevel: JiNotationLevelId): void => {
        ...
        jiNotationLevelElements.push(
            `  <line stroke="black" x1="${leftEdgeX}" x2="${rightEdgeX}" y1="${jiNotationLevelY}" y2="${jiNotationLevelY}"/>\n` as Io,
        )
    })
...
export { visualizeJiNotationLevels }
